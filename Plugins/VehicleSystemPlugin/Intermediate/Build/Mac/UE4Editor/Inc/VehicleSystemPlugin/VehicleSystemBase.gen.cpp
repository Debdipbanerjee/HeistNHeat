...
static struct FScriptStruct_VehicleSystemPlugin_StaticRegisterNativesFVehicleGear
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("VehicleGear")),new UScriptStruct::TCppStructOps<FVehicleGear>);
	}
...
static struct FScriptStruct_VehicleSystemPlugin_StaticRegisterNativesFNetState
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("NetState")),new UScriptStruct::TCppStructOps<FNetState>);
	}
	...
	DEFINE_FUNCTION(AVehicleSystemBase::execAVS_Tick)
	{
		P_GET_PROPERTY(FFloatProperty,Z_Param_DeltaTime);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->AVS_Tick_Implementation(Z_Param_DeltaTime);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(AVehicleSystemBase::execSyncTrailerRotation)
	{
		P_GET_PROPERTY(FFloatProperty,Z_Param_DeltaTime);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SyncTrailerRotation_Implementation(Z_Param_DeltaTime);
		P_NATIVE_END;
	}
	...
	static FName NAME_AVehicleSystemBase_SyncTrailerRotation = FName(TEXT("SyncTrailerRotation"));
	void AVehicleSystemBase::SyncTrailerRotation(float DeltaTime)
	{
		VehicleSystemBase_eventSyncTrailerRotation_Parms Parms;
		Parms.DeltaTime=DeltaTime;
		ProcessEvent(FindFunctionChecked(NAME_AVehicleSystemBase_SyncTrailerRotation),&Parms);
	}
	...
	void AVehicleSystemBase::StaticRegisterNativesAVehicleSystemBase()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "AVS_Tick", &AVehicleSystemBase::execAVS_Tick },
			...
			{ "SyncTrailerRotation", &AVehicleSystemBase::execSyncTrailerRotation },
		};
	...
	struct Z_Construct_UFunction_AVehicleSystemBase_SyncTrailerRotation_Statics
	{
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_DeltaTime;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AVehicleSystemBase_SyncTrailerRotation_Statics::NewProp_DeltaTime = { "DeltaTime", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VehicleSystemBase_eventSyncTrailerRotation_Parms, DeltaTime), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AVehicleSystemBase_SyncTrailerRotation_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AVehicleSystemBase_SyncTrailerRotation_Statics::NewProp_DeltaTime,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AVehicleSystemBase_SyncTrailerRotation_Statics::Function_MetaDataParams[] = {
		{ "Category", "VehicleSystemPlugin" },
		{ "ModuleRelativePath", "Public/VehicleSystemBase.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AVehicleSystemBase_SyncTrailerRotation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AVehicleSystemBase, nullptr, "SyncTrailerRotation", nullptr, nullptr, sizeof(VehicleSystemBase_eventSyncTrailerRotation_Parms), Z_Construct_UFunction_AVehicleSystemBase_SyncTrailerRotation_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AVehicleSystemBase_SyncTrailerRotation_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AVehicleSystemBase_SyncTrailerRotation_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AVehicleSystemBase_SyncTrailerRotation_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AVehicleSystemBase_SyncTrailerRotation()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AVehicleSystemBase_SyncTrailerRotation_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AVehicleSystemBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AVehicleSystemBase_AVS_Tick, "AVS_Tick" }, // 743453951
		...
		{ &Z_Construct_UFunction_AVehicleSystemBase_SyncTrailerRotation, "SyncTrailerRotation" }, // 1896297155
	...
	IMPLEMENT_CLASS(AVehicleSystemBase, 1755619221);
